      ...
      <view>
        <view class="form-item">
          ...
          <radio-group name="radio" @change="goodsChange">
            ...
            <view class="radio"> <radio value="002" /><text>商品2：单组多规格商品</text> </view>
            <view class="radio"> <radio value="003" /><text>商品3：单组单规格商品</text> </view>
            <view class="radio"> <radio value="004" /><text>商品4：暂无库存商品</text> </view>
          </radio-group>
        </view>
        ...
        <view class="form-item" style="margin-top: 20rpx">
          ...
          <radio-group name="radio" @change="skuModeChange">
            <view class="radio"> <radio value="1" checked /><text>都显示</text> </view>
            <view class="radio"> <radio value="2" /><text>只显示购物车</text> </view>
            <view class="radio"> <radio value="3" /><text>只显示立即购买</text> </view>
          </radio-group>
        </view>
        <view class="form-item" style="margin-top: 20rpx">
          <view class="title" style="width: 180rpx">主题风格</view>
          <radio-group name="radio" @change="themeChange">
            <view class="radio"> <radio value="default" checked /><text>默认</text> </view>
            <view class="radio"> <radio value="red-black" /><text>红黑</text> </view>
            <view class="radio"> <radio value="black-white" /><text>黑白</text> </view>
            <view class="radio"> <radio value="coffee" /><text>咖啡</text> </view>
            <view class="radio"> <radio value="green" /><text>浅绿</text> </view>
          </radio-group>
        </view>
        <view class="form-item">
